...
public sealed class SchemaContractTests
{
    ...
    [
        ...
        "association-decision-audit.schema.json",
        ...
        "red-mist-expression-references.schema.json",
    ];
    ...
    [
        ...
        "valid/generation-batch-request.preview.json",
        "valid/generation-batch-request.final.json",
        ...
        "valid/association-decision-audit.primary.json",
        "valid/association-decision-audit.fallback.json",
        ...
        "invalid/generation-batch-request.21-shots.json",
        "invalid/generation-batch-request.duplicate-shot.json",
        "invalid/generation-batch-request.provider.json",
        "invalid/generation-batch-request.final-missing-source.json",
        ...
        "invalid/association-decision-audit.missing-prompt-version.json",
        "invalid/association-decision-audit.missing-guard-results.json",
        "invalid/association-decision-audit.fallback-missing-reason.json",
        "invalid/association-decision-audit.sensitive-additional-property.json",
