...
| 2026-07-16 | M4 进行中 | CX-401~404 已完成 Ledger、AssociationTemplate、关联决策服务与一致性守卫；CX-405~406 待完成。守卫已覆盖实体、事实、NPC 生死/可达、效果、冷却/次数、显式共享且可回滚的原子触发门、批准文本来源、最终状态刷新与拒绝指标。模型复核默认关闭且仅提供 Mock；接入真实 Provider、云预算及新的角色性格/章节语气审核文本仍须经过 2.4 节人工闸门 |
